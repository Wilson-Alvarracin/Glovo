...
<body>
    ...
    <div class='pagina'>
        <div id="platos" class='row2 contenido-pagina'>
        </div>
    </div>
    <!-- Formulario para insertar valoraciones -->
